...
const TrackCard = ({
  ...
  const { setCurrentTrack, setAlbumTracks, setIsPlaying } = useOutletContext();
  ...
  const handleCardClick = () => {
    ...
    console.log("TrackCard: Navigating from", location.pathname);
    navigate("/now-playing", { 
      state: { 
        track, 
        albumTracks, 
        autoPlay: true,
        origin: location.pathname // Pass the current page as origin
      } 
    });
  };
  ...
  const handlePlayClick = (e) => {
    ...
    if (onPlayClick) {
      ...
      console.log("TrackCard: Setting new track and playing");
